# k8s.io/apimachinery Documentation
...
1. **[Overview](00-overview.md)** - High-level architecture and design principles
   - Purpose and goals
   - Key components
   - Data flow
   - Type system
...
2. **[Runtime Package](01-runtime-package.md)** - Core runtime machinery
...
3. **[API Meta Package](02-api-meta-package.md)** - Metadata and resource mapping
   - Metadata accessors
   - RESTMapper
   - RESTMapping
...
4. **[Labels and Fields](03-labels-and-fields-packages.md)** - Selection and filtering
   - Label selectors
   - Field selectors
   - Operators
   - Parsing
...
5. **[Watch Package](04-watch-package.md)** - Real-time change notifications
   - Watch interface
   - Event types
   - StreamWatcher
   - Broadcaster
...
6. **[Serialization](05-serialization.md)** - Multiple format support
   - CodecFactory
   - JSON serializer
   - YAML serializer
   - Protobuf serializer
...
7. **[Utility Packages](06-utility-packages.md)** - Common utilities
...
8. **[Conversion and Resources](07-conversion-and-resources.md)** - Version conversion and quantities
   - Conversion system
